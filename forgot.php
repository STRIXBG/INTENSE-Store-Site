...
<?php
   ...
   if(isset($_POST['submit'])){
        $user = new User();
        $response =  $user->passwordReset($_POST['email']);
   }
?>
<html lang="en">
   <head>
      <?php
         require_once('static-pages/head.php');
         ?>
      <title>INTENSE Clothing | Forgot password</title>
         ...
         <div class="wrapper" style="max-width: 900px;">
            ...
            <section class="mt-5 mb-3 p-3 bg-white rounded shadow-lg">
               <div class="container-fluid">
                  <div class="mb-3">
                     <div class="row">
                        <div class="col text-center mt-2 p-2 border-bottom border-end border-2">
                  ...
                  <div class="wrapper p-3" style="max-width: 500px;">
                     <form action="" method="post" >
                        ...
                        <button class="c-button-1 w-100 mt-3" name="submit" type="submit">Submit</button>
                     </form>
